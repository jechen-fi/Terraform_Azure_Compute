...
locals {
  ...
  managed_local_identity  = try(var.managed_identities[var.extension.managed_identity_key].principal_id, "")
  ...
  fileuri_sa           = local.fileuri_sa_key != "" ? try(var.storage_accounts[var.extension.fileuri_sa_key].primary_blob_endpoint, "") : ""
